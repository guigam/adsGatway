...
@EnableZuulProxy
public class AdsGatwayApp {

    private static final Logger log = LoggerFactory.getLogger(AdsGatwayApp.class);

    private final Environment env;

    public AdsGatwayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes adsGatway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AdsGatwayApp.class);
